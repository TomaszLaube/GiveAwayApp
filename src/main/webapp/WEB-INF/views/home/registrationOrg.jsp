...
<section class="login-page">
    <h2>Zarejestruj konto organizacji</h2>
                ...
                <li>
                    <div class="col">
                        ...
                        <c:forEach items="${receivers}" var="receiver">
                            ...
                            <c:forEach items="${user.orgReceivers}" var="orgReceiver">
                    ...
                    <div class="col">
                        ...
                        <c:forEach items="${goods}" var="good">
                            ...
                            <c:forEach items="${user.orgGoods}" var="orgGood">
                        ...
                        <div class="title">
                            <form:select path="location" required="true">
                                <c:forEach items="${locations}" var="location">
                                    <c:if test="${location.id==user.location.id}">
